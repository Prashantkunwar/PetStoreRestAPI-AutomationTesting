...
public class UserTests2 {
	...
	public void testPostUser() throws InterruptedException {
		...
		Response response = UserEndPoint2.createUser(user_payload);
	...
	public void testGetUser() throws InterruptedException {
		...
		Response response = UserEndPoint2.getUser(this.user_payload.getUsername());
		response.then().log().all();
		Assert.assertEquals(response.getStatusCode(),200);
	...
	public void testUpdateUser() throws InterruptedException {
		...
		Response response = UserEndPoint2.updateUser(this.user_payload.getUsername(), user_payload);
		response.then().log().all();
		Assert.assertEquals(response.getStatusCode(),200);	
		...
		Response response_after_update = UserEndPoint2.getUser(this.user_payload.getUsername());
	...
	public void testDeleteUser() {
		...
		Response response = UserEndPoint2.deleteUser(this.user_payload.getUsername());
		response.then().log().all();
